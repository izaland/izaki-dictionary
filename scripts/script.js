...
<nav class="navbar" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
        <a class="navbar-item" href="index.html">
            <img src="assets/Izaland.png"/> Izaki Dictionary
        </a>
    ...
    <div id="navbarexpand" class="navbar-menu">
        ...
        <div class="navbar-item has-dropdown is-hoverable">
            ...
            <div class="navbar-dropdown">
                <a class="navbar-item" href="pages/byakuzhi/lookup.html">
                    Lookup
                </a>
                <a class="navbar-item">Readings</a>
            </div>
        </div>

        <!-- Dictionary direct link -->
        <a class="navbar-item" href="pages/dictionary/dictionary.html">
            Dictionary
        </a>
        ...
        <div class="navbar-item has-dropdown is-hoverable">
            ...
            <div class="navbar-dropdown">
                <a class="navbar-item">Conjugator</a>
                <a class="navbar-item">Declension</a>
            </div>
        </div>
